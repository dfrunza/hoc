...
cl /c %C_flags% ..\lib.c ..\lex.c ..\syntax.c /Fo
cl %C_flags% ..\hocc.c lib.obj lex.obj syntax.obj /link %L_flags%
...
cloc.exe hasm.h lex.h lib.h runtime_obj.h syntax.h typecheck.h codegen.c hasm.c ^
